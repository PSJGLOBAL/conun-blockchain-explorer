...
const TxnDetailsTable = ({
  ...
  return (
    <div>
      ...
      {tx_to && <DetailsTableRow keyCell="To" select scroll ><ToFromLink dest={tx_to}/></DetailsTableRow>}
      {tx_from && (
        <DetailsTableRow keyCell="From" select scroll ><ToFromLink dest={tx_from}/></DetailsTableRow>
      )}
